...
class LongTrackTrainingDataset(Dataset):
    def __init__(
        ...
        self.global_ids = {
            seq_id_pair: global_id for global_id, seq_id_pair in enumerate(global_ids)
        }
    ...
    def augment(self, boxes):
        ...
        def get_rand_uniform_n(n):
            return 2 * torch.rand(n) - 1

        rand_uniform = get_rand_uniform_n
    ...
    def merge_frame_data(self, past_frame_data: dict, first_past_frame: dict)->dict:  # skipcq: PYL-R0201
